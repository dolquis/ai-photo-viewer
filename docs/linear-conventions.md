...
- AREA_LABELS_TARGET_AFTER_PHASE_4: area-photo-ui, area-image-core, area-ai-runtime, area-db, area-search, area-faces, area-jobs, area-privacy
- STAGE_MAP:
  ...
  # 注: 現 Linear マイルストーン "Stage Three/Four" は §12 命名規約に合わせ "Stage 3/4" へ改名対象 (Phase 3)
